...
import frc.robot.commands.training.shooter.BranchTargetSetpoint;
import frc.robot.commands.training.shooter.FlipTargetSetpoint;
import frc.robot.commands.training.shooter.RequestModelUpdate;
import frc.robot.commands.training.shooter.ResetTargetSetpoint;
import frc.robot.commands.training.shooter.SubmitSetpointData;
import frc.robot.commands.training.shooter.TrainerConfigureShooter;
import frc.robot.commands.training.shooter.TrainerFocusShooter;
import frc.robot.commands.training.shooter.TrainerOperateShooter;
import frc.robot.commands.training.shooter.UndoTargetSetpoint;
import frc.robot.commands.training.shooter.UpdateTargetSetpoint;
