    ...
    public SynchronizedThreeBallsAuto(
        ...
        */
        ...
        Trajectory t2 = TrajectoryGenerator.generateTrajectory(new Pose2d(1.75/kAuto.kDistanceRatio, 0, new Rotation2d(0)),
                                                                   List.of(),
                                                                   new Pose2d((5.14)/kAuto.kDistanceRatio, (-0.45)/kAuto.kDistanceRatio, new Rotation2d(Math.PI*5/36)),
                                                                   kAuto.configForwards);

        Trajectory t3 = TrajectoryGenerator.generateTrajectory(new Pose2d((5.14)/kAuto.kDistanceRatio, (-0.45)/kAuto.kDistanceRatio, new Rotation2d(Math.PI*5/36)),
                                                                   List.of(),
